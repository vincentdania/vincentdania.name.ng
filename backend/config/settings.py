...
CONTACT_NOTIFICATION_EMAIL = os.getenv("CONTACT_NOTIFICATION_EMAIL", "Vincent@hyrax.ng")
CONSULTATION_NOTIFICATION_EMAIL = os.getenv("CONSULTATION_NOTIFICATION_EMAIL", "Vincent@hyrax.ng")
